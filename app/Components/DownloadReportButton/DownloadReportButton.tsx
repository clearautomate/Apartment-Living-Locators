...
export default function DownloadReportButton({ data }: Props) {
    ...
    return (
        <Button onClick={handleClick} color={data ? "primary" : "bg"} disabled={!data} loading={isLoading} size="sm" icon={<HiOutlineDocumentDownload size={24} />} iconPosition="right">Download Report</Button>
    );
}